...
using Gestion_Dette.Service.Impl;
using Gestion_Dette.Service;
using Gestion_Dette.View;
using System;
...
using Gestion_Dette.Core.Factory;
using Gestion_Dette.Enum;

namespace Gestion_Dette
{
    internal class Program
    {
        ...
        {
            IClientRepository clientRepository = ClientFactory.createClientRepository(Persistence.DAPPER);
